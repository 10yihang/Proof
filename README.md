...
**当前版本：0.1.6。** [下载 macOS Apple Silicon 版本](https://github.com/10yihang/Proof/releases/tag/v0.1.6)。其他平台和完整性能验收仍在推进。
...
发布构建：`npm run release:build`，使用本机已有的 updater 签名密钥。普通开发构建可按上面的命令关闭更新包生成，不需要签名私钥。版本与发布说明见 [0.1.6](docs/releases/0.1.6.md)。
